...
ap_uint<192> link_out[48])
{
	...
	else
	{
		...
		// [[transaction]]
		sprintf(tvin_link_out_8_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_8_V, tvin_link_out_8_V);

		sc_bv<192>* link_out_8_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 8; i_0 <= 8; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_8_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_8_V, "%s\n", (link_out_8_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_8_V, tvin_link_out_8_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_8_V_depth);
		sprintf(tvin_link_out_8_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_8_V, tvin_link_out_8_V);

		// release memory allocation
		delete [] link_out_8_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_9_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_9_V, tvin_link_out_9_V);

		sc_bv<192>* link_out_9_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 9; i_0 <= 9; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_9_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_9_V, "%s\n", (link_out_9_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_9_V, tvin_link_out_9_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_9_V_depth);
		sprintf(tvin_link_out_9_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_9_V, tvin_link_out_9_V);

		// release memory allocation
		delete [] link_out_9_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_10_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_10_V, tvin_link_out_10_V);

		sc_bv<192>* link_out_10_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 10; i_0 <= 10; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_10_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_10_V, "%s\n", (link_out_10_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_10_V, tvin_link_out_10_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_10_V_depth);
		sprintf(tvin_link_out_10_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_10_V, tvin_link_out_10_V);

		// release memory allocation
		delete [] link_out_10_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_11_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_11_V, tvin_link_out_11_V);

		sc_bv<192>* link_out_11_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 11; i_0 <= 11; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_11_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_11_V, "%s\n", (link_out_11_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_11_V, tvin_link_out_11_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_11_V_depth);
		sprintf(tvin_link_out_11_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_11_V, tvin_link_out_11_V);

		// release memory allocation
		delete [] link_out_11_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_12_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_12_V, tvin_link_out_12_V);

		sc_bv<192>* link_out_12_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 12; i_0 <= 12; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_12_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_12_V, "%s\n", (link_out_12_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_12_V, tvin_link_out_12_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_12_V_depth);
		sprintf(tvin_link_out_12_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_12_V, tvin_link_out_12_V);

		// release memory allocation
		delete [] link_out_12_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_13_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_13_V, tvin_link_out_13_V);

		sc_bv<192>* link_out_13_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 13; i_0 <= 13; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_13_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_13_V, "%s\n", (link_out_13_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_13_V, tvin_link_out_13_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_13_V_depth);
		sprintf(tvin_link_out_13_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_13_V, tvin_link_out_13_V);

		// release memory allocation
		delete [] link_out_13_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_14_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_14_V, tvin_link_out_14_V);

		sc_bv<192>* link_out_14_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 14; i_0 <= 14; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_14_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_14_V, "%s\n", (link_out_14_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_14_V, tvin_link_out_14_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_14_V_depth);
		sprintf(tvin_link_out_14_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_14_V, tvin_link_out_14_V);

		// release memory allocation
		delete [] link_out_14_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_15_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_15_V, tvin_link_out_15_V);

		sc_bv<192>* link_out_15_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 15; i_0 <= 15; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_15_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_15_V, "%s\n", (link_out_15_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_15_V, tvin_link_out_15_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_15_V_depth);
		sprintf(tvin_link_out_15_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_15_V, tvin_link_out_15_V);

		// release memory allocation
		delete [] link_out_15_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_16_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_16_V, tvin_link_out_16_V);

		sc_bv<192>* link_out_16_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 16; i_0 <= 16; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_16_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_16_V, "%s\n", (link_out_16_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_16_V, tvin_link_out_16_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_16_V_depth);
		sprintf(tvin_link_out_16_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_16_V, tvin_link_out_16_V);

		// release memory allocation
		delete [] link_out_16_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_17_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_17_V, tvin_link_out_17_V);

		sc_bv<192>* link_out_17_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 17; i_0 <= 17; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_17_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_17_V, "%s\n", (link_out_17_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_17_V, tvin_link_out_17_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_17_V_depth);
		sprintf(tvin_link_out_17_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_17_V, tvin_link_out_17_V);

		// release memory allocation
		delete [] link_out_17_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_18_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_18_V, tvin_link_out_18_V);

		sc_bv<192>* link_out_18_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 18; i_0 <= 18; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_18_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_18_V, "%s\n", (link_out_18_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_18_V, tvin_link_out_18_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_18_V_depth);
		sprintf(tvin_link_out_18_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_18_V, tvin_link_out_18_V);

		// release memory allocation
		delete [] link_out_18_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_19_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_19_V, tvin_link_out_19_V);

		sc_bv<192>* link_out_19_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 19; i_0 <= 19; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_19_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_19_V, "%s\n", (link_out_19_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_19_V, tvin_link_out_19_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_19_V_depth);
		sprintf(tvin_link_out_19_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_19_V, tvin_link_out_19_V);

		// release memory allocation
		delete [] link_out_19_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_20_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_20_V, tvin_link_out_20_V);

		sc_bv<192>* link_out_20_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 20; i_0 <= 20; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_20_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_20_V, "%s\n", (link_out_20_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_20_V, tvin_link_out_20_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_20_V_depth);
		sprintf(tvin_link_out_20_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_20_V, tvin_link_out_20_V);

		// release memory allocation
		delete [] link_out_20_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_21_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_21_V, tvin_link_out_21_V);

		sc_bv<192>* link_out_21_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 21; i_0 <= 21; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_21_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_21_V, "%s\n", (link_out_21_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_21_V, tvin_link_out_21_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_21_V_depth);
		sprintf(tvin_link_out_21_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_21_V, tvin_link_out_21_V);

		// release memory allocation
		delete [] link_out_21_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_22_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_22_V, tvin_link_out_22_V);

		sc_bv<192>* link_out_22_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 22; i_0 <= 22; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_22_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_22_V, "%s\n", (link_out_22_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_22_V, tvin_link_out_22_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_22_V_depth);
		sprintf(tvin_link_out_22_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_22_V, tvin_link_out_22_V);

		// release memory allocation
		delete [] link_out_22_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_23_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_23_V, tvin_link_out_23_V);

		sc_bv<192>* link_out_23_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 23; i_0 <= 23; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_23_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_23_V, "%s\n", (link_out_23_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_23_V, tvin_link_out_23_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_23_V_depth);
		sprintf(tvin_link_out_23_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_23_V, tvin_link_out_23_V);

		// release memory allocation
		delete [] link_out_23_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_24_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_24_V, tvin_link_out_24_V);

		sc_bv<192>* link_out_24_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 24; i_0 <= 24; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_24_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_24_V, "%s\n", (link_out_24_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_24_V, tvin_link_out_24_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_24_V_depth);
		sprintf(tvin_link_out_24_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_24_V, tvin_link_out_24_V);

		// release memory allocation
		delete [] link_out_24_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_25_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_25_V, tvin_link_out_25_V);

		sc_bv<192>* link_out_25_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 25; i_0 <= 25; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_25_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_25_V, "%s\n", (link_out_25_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_25_V, tvin_link_out_25_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_25_V_depth);
		sprintf(tvin_link_out_25_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_25_V, tvin_link_out_25_V);

		// release memory allocation
		delete [] link_out_25_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_26_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_26_V, tvin_link_out_26_V);

		sc_bv<192>* link_out_26_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 26; i_0 <= 26; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_26_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_26_V, "%s\n", (link_out_26_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_26_V, tvin_link_out_26_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_26_V_depth);
		sprintf(tvin_link_out_26_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_26_V, tvin_link_out_26_V);

		// release memory allocation
		delete [] link_out_26_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_27_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_27_V, tvin_link_out_27_V);

		sc_bv<192>* link_out_27_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 27; i_0 <= 27; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_27_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_27_V, "%s\n", (link_out_27_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_27_V, tvin_link_out_27_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_27_V_depth);
		sprintf(tvin_link_out_27_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_27_V, tvin_link_out_27_V);

		// release memory allocation
		delete [] link_out_27_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_28_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_28_V, tvin_link_out_28_V);

		sc_bv<192>* link_out_28_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 28; i_0 <= 28; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_28_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_28_V, "%s\n", (link_out_28_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_28_V, tvin_link_out_28_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_28_V_depth);
		sprintf(tvin_link_out_28_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_28_V, tvin_link_out_28_V);

		// release memory allocation
		delete [] link_out_28_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_29_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_29_V, tvin_link_out_29_V);

		sc_bv<192>* link_out_29_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 29; i_0 <= 29; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_29_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_29_V, "%s\n", (link_out_29_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_29_V, tvin_link_out_29_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_29_V_depth);
		sprintf(tvin_link_out_29_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_29_V, tvin_link_out_29_V);

		// release memory allocation
		delete [] link_out_29_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_30_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_30_V, tvin_link_out_30_V);

		sc_bv<192>* link_out_30_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 30; i_0 <= 30; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_30_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_30_V, "%s\n", (link_out_30_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_30_V, tvin_link_out_30_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_30_V_depth);
		sprintf(tvin_link_out_30_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_30_V, tvin_link_out_30_V);

		// release memory allocation
		delete [] link_out_30_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_31_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_31_V, tvin_link_out_31_V);

		sc_bv<192>* link_out_31_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 31; i_0 <= 31; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_31_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_31_V, "%s\n", (link_out_31_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_31_V, tvin_link_out_31_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_31_V_depth);
		sprintf(tvin_link_out_31_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_31_V, tvin_link_out_31_V);

		// release memory allocation
		delete [] link_out_31_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_32_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_32_V, tvin_link_out_32_V);

		sc_bv<192>* link_out_32_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 32; i_0 <= 32; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_32_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_32_V, "%s\n", (link_out_32_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_32_V, tvin_link_out_32_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_32_V_depth);
		sprintf(tvin_link_out_32_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_32_V, tvin_link_out_32_V);

		// release memory allocation
		delete [] link_out_32_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_33_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_33_V, tvin_link_out_33_V);

		sc_bv<192>* link_out_33_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 33; i_0 <= 33; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_33_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_33_V, "%s\n", (link_out_33_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_33_V, tvin_link_out_33_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_33_V_depth);
		sprintf(tvin_link_out_33_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_33_V, tvin_link_out_33_V);

		// release memory allocation
		delete [] link_out_33_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_34_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_34_V, tvin_link_out_34_V);

		sc_bv<192>* link_out_34_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 34; i_0 <= 34; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_34_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_34_V, "%s\n", (link_out_34_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_34_V, tvin_link_out_34_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_34_V_depth);
		sprintf(tvin_link_out_34_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_34_V, tvin_link_out_34_V);

		// release memory allocation
		delete [] link_out_34_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_35_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_35_V, tvin_link_out_35_V);

		sc_bv<192>* link_out_35_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 35; i_0 <= 35; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_35_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_35_V, "%s\n", (link_out_35_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_35_V, tvin_link_out_35_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_35_V_depth);
		sprintf(tvin_link_out_35_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_35_V, tvin_link_out_35_V);

		// release memory allocation
		delete [] link_out_35_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_36_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_36_V, tvin_link_out_36_V);

		sc_bv<192>* link_out_36_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 36; i_0 <= 36; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_36_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_36_V, "%s\n", (link_out_36_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_36_V, tvin_link_out_36_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_36_V_depth);
		sprintf(tvin_link_out_36_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_36_V, tvin_link_out_36_V);

		// release memory allocation
		delete [] link_out_36_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_37_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_37_V, tvin_link_out_37_V);

		sc_bv<192>* link_out_37_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 37; i_0 <= 37; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_37_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_37_V, "%s\n", (link_out_37_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_37_V, tvin_link_out_37_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_37_V_depth);
		sprintf(tvin_link_out_37_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_37_V, tvin_link_out_37_V);

		// release memory allocation
		delete [] link_out_37_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_38_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_38_V, tvin_link_out_38_V);

		sc_bv<192>* link_out_38_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 38; i_0 <= 38; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_38_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_38_V, "%s\n", (link_out_38_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_38_V, tvin_link_out_38_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_38_V_depth);
		sprintf(tvin_link_out_38_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_38_V, tvin_link_out_38_V);

		// release memory allocation
		delete [] link_out_38_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_39_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_39_V, tvin_link_out_39_V);

		sc_bv<192>* link_out_39_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 39; i_0 <= 39; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_39_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_39_V, "%s\n", (link_out_39_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_39_V, tvin_link_out_39_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_39_V_depth);
		sprintf(tvin_link_out_39_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_39_V, tvin_link_out_39_V);

		// release memory allocation
		delete [] link_out_39_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_40_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_40_V, tvin_link_out_40_V);

		sc_bv<192>* link_out_40_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 40; i_0 <= 40; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_40_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_40_V, "%s\n", (link_out_40_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_40_V, tvin_link_out_40_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_40_V_depth);
		sprintf(tvin_link_out_40_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_40_V, tvin_link_out_40_V);

		// release memory allocation
		delete [] link_out_40_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_41_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_41_V, tvin_link_out_41_V);

		sc_bv<192>* link_out_41_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 41; i_0 <= 41; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_41_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_41_V, "%s\n", (link_out_41_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_41_V, tvin_link_out_41_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_41_V_depth);
		sprintf(tvin_link_out_41_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_41_V, tvin_link_out_41_V);

		// release memory allocation
		delete [] link_out_41_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_42_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_42_V, tvin_link_out_42_V);

		sc_bv<192>* link_out_42_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 42; i_0 <= 42; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_42_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_42_V, "%s\n", (link_out_42_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_42_V, tvin_link_out_42_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_42_V_depth);
		sprintf(tvin_link_out_42_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_42_V, tvin_link_out_42_V);

		// release memory allocation
		delete [] link_out_42_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_43_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_43_V, tvin_link_out_43_V);

		sc_bv<192>* link_out_43_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 43; i_0 <= 43; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_43_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_43_V, "%s\n", (link_out_43_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_43_V, tvin_link_out_43_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_43_V_depth);
		sprintf(tvin_link_out_43_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_43_V, tvin_link_out_43_V);

		// release memory allocation
		delete [] link_out_43_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_44_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_44_V, tvin_link_out_44_V);

		sc_bv<192>* link_out_44_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 44; i_0 <= 44; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_44_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_44_V, "%s\n", (link_out_44_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_44_V, tvin_link_out_44_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_44_V_depth);
		sprintf(tvin_link_out_44_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_44_V, tvin_link_out_44_V);

		// release memory allocation
		delete [] link_out_44_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_45_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_45_V, tvin_link_out_45_V);

		sc_bv<192>* link_out_45_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 45; i_0 <= 45; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_45_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_45_V, "%s\n", (link_out_45_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_45_V, tvin_link_out_45_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_45_V_depth);
		sprintf(tvin_link_out_45_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_45_V, tvin_link_out_45_V);

		// release memory allocation
		delete [] link_out_45_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_46_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_46_V, tvin_link_out_46_V);

		sc_bv<192>* link_out_46_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 46; i_0 <= 46; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_46_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_46_V, "%s\n", (link_out_46_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_46_V, tvin_link_out_46_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_46_V_depth);
		sprintf(tvin_link_out_46_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_46_V, tvin_link_out_46_V);

		// release memory allocation
		delete [] link_out_46_V_tvin_wrapc_buffer;

		// [[transaction]]
		sprintf(tvin_link_out_47_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_link_out_47_V, tvin_link_out_47_V);

		sc_bv<192>* link_out_47_V_tvin_wrapc_buffer = new sc_bv<192>[1];
				...
				// celement: link_out.V(191, 0)
				{
					...
					for (int i_0 = 47; i_0 <= 47; i_0 += 2)
					{
						...
						if (&(link_out[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<192> link_out_V_tmp_mem;
							link_out_V_tmp_mem = (link_out[i_0]).to_string(2).c_str();
							link_out_47_V_tvin_wrapc_buffer[hls_map_index].range(191, 0) = link_out_V_tmp_mem.range(191, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_link_out_47_V, "%s\n", (link_out_47_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_link_out_47_V, tvin_link_out_47_V);
		}

		tcl_file.set_num(1, &tcl_file.link_out_47_V_depth);
		sprintf(tvin_link_out_47_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_link_out_47_V, tvin_link_out_47_V);

		// release memory allocation
		delete [] link_out_47_V_tvin_wrapc_buffer;
